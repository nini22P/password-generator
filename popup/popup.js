...
function changeRange() {
    if (document.getElementById('length').value == '') {
        ...
        document.getElementById('range').value = document.getElementById('length').value;
}

function changeLength() {
    document.getElementById('length').value = document.getElementById('range').value;
}
...
function checkLanguage() {
    if (chrome.i18n.getMessage('isEn') == 'false') {
        document.getElementById('symbolsCheckBoxSpan').innerHTML = chrome.i18n.getMessage("symbols");
        document.getElementById('copyButon').innerHTML = chrome.i18n.getMessage("copy");
    }
}
...
document.getElementById('symbolsCheckBox').onchange = createPasswordBysymbolsCheckBox;
